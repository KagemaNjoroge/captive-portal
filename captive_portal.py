...
IFACE = "ap0"  # the interface that captive portal protects
IP_ADDRESS = (
    "192.168.12.1"  # the ip address of the captive portal (it can be the IP of IFACE)
)
...
class CaptivePortal(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if username == "nikos" and password == "fotiou":
            ...
            self.wfile.write(b"You are now authorized. Navigate to any URL")
        else:
            # show the login form
